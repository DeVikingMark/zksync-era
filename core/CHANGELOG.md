...
## [27.0.0](https://github.com/DeVikingMark/zksync-era/compare/core-v26.4.0...core-v27.0.0) (2025-02-27)


### ⚠ BREAKING CHANGES

* **contracts:** gateway integration ([#1934](https://github.com/DeVikingMark/zksync-era/issues/1934))
* **contracts:** integrate protocol defense changes ([#2737](https://github.com/DeVikingMark/zksync-era/issues/2737))

### Features

* Adapt server for new EVM bytecode hash encoding ([#3396](https://github.com/DeVikingMark/zksync-era/issues/3396)) ([5a1e6d2](https://github.com/DeVikingMark/zksync-era/commit/5a1e6d2445d4d4310fc1e54ccd44dc4254e5bcbc))
* Add  initial version prover_autoscaler ([#2993](https://github.com/DeVikingMark/zksync-era/issues/2993)) ([ebf9604](https://github.com/DeVikingMark/zksync-era/commit/ebf9604c5ab2a1cae1ffd2f9c922f35a1d0ad876))
* add `block.timestamp` asserter for AA ([#3031](https://github.com/DeVikingMark/zksync-era/issues/3031)) ([069d38d](https://github.com/DeVikingMark/zksync-era/commit/069d38d6c9ddd8b6c404596c479f94b9fc86db40))
* add a flag for stage1-&gt;stage2 validium migration ([#3562](https://github.com/DeVikingMark/zksync-era/issues/3562)) ([92e7895](https://github.com/DeVikingMark/zksync-era/commit/92e78955850e59f16967dff20122d56144509498))
* Add CoinMarketCap external API ([#2971](https://github.com/DeVikingMark/zksync-era/issues/2971)) ([c1cb30e](https://github.com/DeVikingMark/zksync-era/commit/c1cb30e59ca1d0b5fea5fe0980082aea0eb04aa2))
* Add logging & metrics for mempool ([#3447](https://github.com/DeVikingMark/zksync-era/issues/3447)) ([64d861d](https://github.com/DeVikingMark/zksync-era/commit/64d861d1e1d2d46339938ee3174c58cdc3f348c3))
* add metric to track current cbt ratio ([#3020](https://github.com/DeVikingMark/zksync-era/issues/3020)) ([3fd2fb1](https://github.com/DeVikingMark/zksync-era/commit/3fd2fb14e7283c6858731e162522e70051a8e162))
* add more metrics for the tee_prover ([#3276](https://github.com/DeVikingMark/zksync-era/issues/3276)) ([8b62434](https://github.com/DeVikingMark/zksync-era/commit/8b62434a3b48aea2e66b5dd833f52c58e26969cb))
* add support for custom genesis state ([#3259](https://github.com/DeVikingMark/zksync-era/issues/3259)) ([3cffdb2](https://github.com/DeVikingMark/zksync-era/commit/3cffdb2d5e144f2e3d8617fa22aacf6cce5998a2))
* added seed_peers to consensus global config ([#2920](https://github.com/DeVikingMark/zksync-era/issues/2920)) ([e9d1d90](https://github.com/DeVikingMark/zksync-era/commit/e9d1d905f1ce86f9de2cf39d79be4b5aada4a81d))
* allow vm2 tracers to stop execution ([#3183](https://github.com/DeVikingMark/zksync-era/issues/3183)) ([9dae839](https://github.com/DeVikingMark/zksync-era/commit/9dae839935d82a1e73be220d17567f3382131039))
* **api_server:** report gas price based on open batch ([#2868](https://github.com/DeVikingMark/zksync-era/issues/2868)) ([f30aca0](https://github.com/DeVikingMark/zksync-era/commit/f30aca00962aa34c8a7acd6e4116290a2b214dcb))
* **api-server:** add `yParity` for non-legacy txs ([#3246](https://github.com/DeVikingMark/zksync-era/issues/3246)) ([6ea36d1](https://github.com/DeVikingMark/zksync-era/commit/6ea36d14940a19f638512556ccc4c5127150b5c9))
* **api:** get rid of tx receipt root ([#3187](https://github.com/DeVikingMark/zksync-era/issues/3187)) ([6c034f6](https://github.com/DeVikingMark/zksync-era/commit/6c034f6e180cc92e99766f14c8840c90efa56cec))
* **api:** Implement eth_maxPriorityFeePerGas ([#3135](https://github.com/DeVikingMark/zksync-era/issues/3135)) ([35e84cc](https://github.com/DeVikingMark/zksync-era/commit/35e84cc03a7fdd315932fb3020fe41c95a6e4bca))
* **api:** Integrate new VM into API server (no tracers) ([#3033](https://github.com/DeVikingMark/zksync-era/issues/3033)) ([8e75d4b](https://github.com/DeVikingMark/zksync-era/commit/8e75d4b812b21bc26e2c38ceeb711a8a530d7bc2))
* **api:** Make acceptable values cache lag configurable ([#3028](https://github.com/DeVikingMark/zksync-era/issues/3028)) ([6747529](https://github.com/DeVikingMark/zksync-era/commit/67475292ff770d2edd6884be27f976a4144778ae))
* Avail gas relay upgrade ([#3601](https://github.com/DeVikingMark/zksync-era/issues/3601)) ([e32fee0](https://github.com/DeVikingMark/zksync-era/commit/e32fee04bfcfd46f4ed2edf2ea564f7aafd5db10))
* base token integration tests ([#2509](https://github.com/DeVikingMark/zksync-era/issues/2509)) ([8db7e93](https://github.com/DeVikingMark/zksync-era/commit/8db7e9306e5fa23f066be106363e6455531bbc09))
* change seal criteria for gateway ([#3320](https://github.com/DeVikingMark/zksync-era/issues/3320)) ([a0a74aa](https://github.com/DeVikingMark/zksync-era/commit/a0a74aaeb42f076d20c4ae8a32925eff2de11d0c))
* **circuit_prover:** Add circuit prover ([#2908](https://github.com/DeVikingMark/zksync-era/issues/2908)) ([48317e6](https://github.com/DeVikingMark/zksync-era/commit/48317e640a00b016bf7bf782cc94fccaf077ed6d))
* Compressor optimizations ([#3476](https://github.com/DeVikingMark/zksync-era/issues/3476)) ([3e931be](https://github.com/DeVikingMark/zksync-era/commit/3e931be6bddaacbd7d029c537db03a3c191fdc21))
* **configs:** Add port parameter to ConsensusConfig ([#2986](https://github.com/DeVikingMark/zksync-era/issues/2986)) ([25112df](https://github.com/DeVikingMark/zksync-era/commit/25112df39d052f083bc45964f0298b3af5842cac))
* **configs:** Add port parameter to ConsensusConfig ([#3051](https://github.com/DeVikingMark/zksync-era/issues/3051)) ([038c397](https://github.com/DeVikingMark/zksync-era/commit/038c397ce842601da5109c460b09dbf9d51cf2fc))
* **consensus:** Added view_timeout to consensus config ([#3383](https://github.com/DeVikingMark/zksync-era/issues/3383)) ([fc02a8f](https://github.com/DeVikingMark/zksync-era/commit/fc02a8f1c9f0bffb438fb27769d6dced3ce14cd9))
* **consensus:** enabled syncing pregenesis blocks over p2p ([#3192](https://github.com/DeVikingMark/zksync-era/issues/3192)) ([6adb224](https://github.com/DeVikingMark/zksync-era/commit/6adb2249ff0946ec6d02f25437c9f71b1079ad79))
* **consensus:** fallback json rpc syncing for consensus ([#3211](https://github.com/DeVikingMark/zksync-era/issues/3211)) ([726203b](https://github.com/DeVikingMark/zksync-era/commit/726203bab540e3d6ada10b6bc12bd3c09220d895))
* **consensus:** smooth transition to p2p syncing (BFT-515) ([#3075](https://github.com/DeVikingMark/zksync-era/issues/3075)) ([5d339b4](https://github.com/DeVikingMark/zksync-era/commit/5d339b46fee66bc3a45493586626d318380680dd))
* **consensus:** Support for syncing blocks before consensus genesis over p2p network ([#3040](https://github.com/DeVikingMark/zksync-era/issues/3040)) ([d3edc3d](https://github.com/DeVikingMark/zksync-era/commit/d3edc3d817c151ed00d4fa822fdae0a746e33356))
* **contract-verifier:** Adapt contract verifier API for EVM bytecodes ([#3234](https://github.com/DeVikingMark/zksync-era/issues/3234)) ([4509179](https://github.com/DeVikingMark/zksync-era/commit/4509179f62ead4b837dfb67760f52de76fac2e37))
* **contract-verifier:** Do not allow verification requests for verified contracts ([#3578](https://github.com/DeVikingMark/zksync-era/issues/3578)) ([6a1f1b8](https://github.com/DeVikingMark/zksync-era/commit/6a1f1b801b49cec45e6e4e4b8596d866fa8fe819))
* **contract-verifier:** Download compilers from GH automatically ([#3291](https://github.com/DeVikingMark/zksync-era/issues/3291)) ([a10c4ba](https://github.com/DeVikingMark/zksync-era/commit/a10c4baa312f26ebac2a10115fb7bd314d18b9c1))
* **contract-verifier:** Partial matching & automatic verification ([#3527](https://github.com/DeVikingMark/zksync-era/issues/3527)) ([bf9fe85](https://github.com/DeVikingMark/zksync-era/commit/bf9fe85f4fd1d739105e7b21d0eebb377f752bac))
* **contract-verifier:** Support missing options for EVM in API ([#3592](https://github.com/DeVikingMark/zksync-era/issues/3592)) ([309fdf4](https://github.com/DeVikingMark/zksync-era/commit/309fdf43e93ed7a584c46227b0a3c088d658887d))
* **contract-verifier:** Support Solidity contracts with EVM bytecode in contract verifier ([#3225](https://github.com/DeVikingMark/zksync-era/issues/3225)) ([8a3a82c](https://github.com/DeVikingMark/zksync-era/commit/8a3a82ca16479183e96505bc91011fc07bfc6889))
* **contract-verifier:** Support Vyper toolchain for EVM bytecodes ([#3251](https://github.com/DeVikingMark/zksync-era/issues/3251)) ([75f7db9](https://github.com/DeVikingMark/zksync-era/commit/75f7db9b535b4dee4c6662be609aec996555383c))
* **contracts:** gateway integration ([#1934](https://github.com/DeVikingMark/zksync-era/issues/1934)) ([f06cb79](https://github.com/DeVikingMark/zksync-era/commit/f06cb79883bf320f50089099e0abeb95eaace470))
* **contracts:** integrate protocol defense changes ([#2737](https://github.com/DeVikingMark/zksync-era/issues/2737)) ([c60a348](https://github.com/DeVikingMark/zksync-era/commit/c60a3482ee09b3e371163e62f49e83bc6d6f4548))
* da_dispatcher refactoring ([#3409](https://github.com/DeVikingMark/zksync-era/issues/3409)) ([591cd86](https://github.com/DeVikingMark/zksync-era/commit/591cd86a1a1e6e4214d3cec74b4c601356060203))
* **da-clients:** add Celestia client ([#2983](https://github.com/DeVikingMark/zksync-era/issues/2983)) ([d88b875](https://github.com/DeVikingMark/zksync-era/commit/d88b875464ec5ac7e54aba0cc7c0a68c01969782))
* **da-clients:** add EigenDA client ([#3155](https://github.com/DeVikingMark/zksync-era/issues/3155)) ([5161eed](https://github.com/DeVikingMark/zksync-era/commit/5161eeda5905d33f4d038a2a04ced3e06f39d593))
* **da-clients:** add secrets ([#2954](https://github.com/DeVikingMark/zksync-era/issues/2954)) ([f4631e4](https://github.com/DeVikingMark/zksync-era/commit/f4631e4466de620cc1401b326d864cdb8b48a05d))
* **da-clients:** raise Avail blob size to 1mb ([#3624](https://github.com/DeVikingMark/zksync-era/issues/3624)) ([0baa7ff](https://github.com/DeVikingMark/zksync-era/commit/0baa7ff61805e90b1eaac202ed6e26f5cacfb532))
* **eigenda:** implement eigenDA client remaining features ([#3243](https://github.com/DeVikingMark/zksync-era/issues/3243)) ([88fc971](https://github.com/DeVikingMark/zksync-era/commit/88fc9714b42e3cb81dab970ec55b2bbfe0c49f52))
* emit errors in prover API metrics ([#2890](https://github.com/DeVikingMark/zksync-era/issues/2890)) ([2ac7cc5](https://github.com/DeVikingMark/zksync-era/commit/2ac7cc5836e69fc82c98df2005fedee01c1084e1))
* **en:** better EN default req entities limit, improved documentation for API limits ([#3546](https://github.com/DeVikingMark/zksync-era/issues/3546)) ([e7eb716](https://github.com/DeVikingMark/zksync-era/commit/e7eb716c241c8bf224361fee150f9d1fe3023ebb))
* **en:** make documentation more chain agnostic ([#3376](https://github.com/DeVikingMark/zksync-era/issues/3376)) ([361243f](https://github.com/DeVikingMark/zksync-era/commit/361243f3f15e01cf1f3e49b73a579cb962cf0124))
* **en:** periodically fetch bridge addresses ([#2949](https://github.com/DeVikingMark/zksync-era/issues/2949)) ([e984bfb](https://github.com/DeVikingMark/zksync-era/commit/e984bfb8a243bc746549ab9347dc0a367fe02790))
* **en:** Resume incomplete snapshot in snapshot creator in more cases ([#2886](https://github.com/DeVikingMark/zksync-era/issues/2886)) ([f095b4a](https://github.com/DeVikingMark/zksync-era/commit/f095b4a3223222ac712de53592fe1e68f766600f))
* **en:** Support Merkle tree recovery with pruning enabled ([#3172](https://github.com/DeVikingMark/zksync-era/issues/3172)) ([7b8640a](https://github.com/DeVikingMark/zksync-era/commit/7b8640a89fa8666e14934481317c94f07280e591))
* **eth-sender:** add a cap to time_in_mempool ([#2978](https://github.com/DeVikingMark/zksync-era/issues/2978)) ([650d42f](https://github.com/DeVikingMark/zksync-era/commit/650d42fea6124d80b60a8270a303d72ad6ac741e))
* **eth-sender:** add time_in_mempool_cap config ([#3018](https://github.com/DeVikingMark/zksync-era/issues/3018)) ([f6d86bd](https://github.com/DeVikingMark/zksync-era/commit/f6d86bd7935a1cdbb528b13437424031fda3cb8e))
* **eth-sender:** make base fee grow at least as fast as priority fee ([#3386](https://github.com/DeVikingMark/zksync-era/issues/3386)) ([78af2bf](https://github.com/DeVikingMark/zksync-era/commit/78af2bf786bb4f7a639fef9fd169594101818b79))
* **eth-watch:** catch another reth error ([#3026](https://github.com/DeVikingMark/zksync-era/issues/3026)) ([4640c42](https://github.com/DeVikingMark/zksync-era/commit/4640c4233af46c97f207d2dbce5fedd1bcb66c43))
* **eth-watch:** Change protocol upgrade schema ([#3435](https://github.com/DeVikingMark/zksync-era/issues/3435)) ([2c778fd](https://github.com/DeVikingMark/zksync-era/commit/2c778fdd3fcd1e774bcb945f14a640ccf4227a2f))
* **eth-watch:** redesign to support multiple chains ([#2867](https://github.com/DeVikingMark/zksync-era/issues/2867)) ([aa72d84](https://github.com/DeVikingMark/zksync-era/commit/aa72d849c24a664acd083eba73795ddc5d31d55f))
* Expose http debug page ([#2952](https://github.com/DeVikingMark/zksync-era/issues/2952)) ([e0b6488](https://github.com/DeVikingMark/zksync-era/commit/e0b64888aae7324aec2d40fa0cd51ea7e1450cd9))
* **external-node:** save protocol version before opening a batch ([#3136](https://github.com/DeVikingMark/zksync-era/issues/3136)) ([d6de4f4](https://github.com/DeVikingMark/zksync-era/commit/d6de4f40ddce339c760c95e2bf4b8aceb571af7f))
* Features for an easier upgrade ([#3422](https://github.com/DeVikingMark/zksync-era/issues/3422)) ([3037ee6](https://github.com/DeVikingMark/zksync-era/commit/3037ee6aa976744a09882b5830d6242ad8336717))
* FFLONK support for compressor ([#3359](https://github.com/DeVikingMark/zksync-era/issues/3359)) ([1a297be](https://github.com/DeVikingMark/zksync-era/commit/1a297bedd226c56fc2ba02dc54d79129a271a1eb))
* gateway preparation ([#3006](https://github.com/DeVikingMark/zksync-era/issues/3006)) ([16f2757](https://github.com/DeVikingMark/zksync-era/commit/16f275756cd28024a6b11ac1ac327eb5b8b446e1))
* Handle new yul compilation flow ([#3038](https://github.com/DeVikingMark/zksync-era/issues/3038)) ([4035361](https://github.com/DeVikingMark/zksync-era/commit/40353616f278800dc80fcbe5f2a6483019033b20))
* Implement gas relay mode and inclusion data for data attestation ([#3070](https://github.com/DeVikingMark/zksync-era/issues/3070)) ([561fc1b](https://github.com/DeVikingMark/zksync-era/commit/561fc1bddfc79061dab9d8d150baa06acfa90692))
* integrate gateway changes for some components ([#3274](https://github.com/DeVikingMark/zksync-era/issues/3274)) ([cbc91e3](https://github.com/DeVikingMark/zksync-era/commit/cbc91e35f84d04f2e4c8e81028596db009e478d1))
* make `to` address optional for transaction data ([#2852](https://github.com/DeVikingMark/zksync-era/issues/2852)) ([8363c1d](https://github.com/DeVikingMark/zksync-era/commit/8363c1d8697ad9bd2fe5d326218476bc3dad38af))
* make `zksync_types` thinner ([#3574](https://github.com/DeVikingMark/zksync-era/issues/3574)) ([e7f93e4](https://github.com/DeVikingMark/zksync-era/commit/e7f93e43dd55674a1442111cc1f08c9d229d3e22))
* **metadata-calculator:** Add debug endpoints for tree API ([#3167](https://github.com/DeVikingMark/zksync-era/issues/3167)) ([3815252](https://github.com/DeVikingMark/zksync-era/commit/3815252790fd0e9094f308b58dfde3a8b1a82277))
* new da_dispatcher metrics ([#3464](https://github.com/DeVikingMark/zksync-era/issues/3464)) ([75a7c08](https://github.com/DeVikingMark/zksync-era/commit/75a7c08868e5f794be0c50b012164fcba5846f08))
* preparation for new precompiles ([#3535](https://github.com/DeVikingMark/zksync-era/issues/3535)) ([3c1f3fb](https://github.com/DeVikingMark/zksync-era/commit/3c1f3fb0f24d1c19dce52b98df521703fa1bf638))
* **proof-data-handler:** add first processed batch option ([#3112](https://github.com/DeVikingMark/zksync-era/issues/3112)) ([1eb69d4](https://github.com/DeVikingMark/zksync-era/commit/1eb69d467802d07f3fc6502de97ff04a69f952fc))
* **proof-data-handler:** add tee_proof_generation_timeout_in_secs param ([#3128](https://github.com/DeVikingMark/zksync-era/issues/3128)) ([f3724a7](https://github.com/DeVikingMark/zksync-era/commit/f3724a71c7466451d380981b05d68d8afd70cdca))
* **proof-data-handler:** exclude batches without object file in GCS  ([#2980](https://github.com/DeVikingMark/zksync-era/issues/2980)) ([3e309e0](https://github.com/DeVikingMark/zksync-era/commit/3e309e06b24649c74bfe120e8ca45247cb2b5628))
* Prover e2e test ([#2975](https://github.com/DeVikingMark/zksync-era/issues/2975)) ([0edd796](https://github.com/DeVikingMark/zksync-era/commit/0edd7962429b3530ae751bd7cc947c97193dd0ca))
* **prover:** Add endpoint to PJM to get queue reports ([#2918](https://github.com/DeVikingMark/zksync-era/issues/2918)) ([2cec83f](https://github.com/DeVikingMark/zksync-era/commit/2cec83f26e0b9309387135ca43718af4fcd6f6b1))
* **prover:** Add min_provers and dry_run features. Improve metrics and test. ([#3129](https://github.com/DeVikingMark/zksync-era/issues/3129)) ([7c28964](https://github.com/DeVikingMark/zksync-era/commit/7c289649b7b3c418c7193a35b51c264cf4970f3c))
* **prover:** Add queue metric to report autoscaler view of the queue. ([#3206](https://github.com/DeVikingMark/zksync-era/issues/3206)) ([2721396](https://github.com/DeVikingMark/zksync-era/commit/272139690e028d3bdebdb6bcb1824fec23cefd0f))
* **prover:** Add sending scale requests for Scaler targets ([#3194](https://github.com/DeVikingMark/zksync-era/issues/3194)) ([767c5bc](https://github.com/DeVikingMark/zksync-era/commit/767c5bc6a62c402c099abe93b7dbecbb59e4acb7))
* **prover:** Add support for scaling WGs and compressor ([#3179](https://github.com/DeVikingMark/zksync-era/issues/3179)) ([c41db9e](https://github.com/DeVikingMark/zksync-era/commit/c41db9ecec1c21b80969604f703ac6990f6f3434))
* ProverJobProcessor & circuit prover ([#3287](https://github.com/DeVikingMark/zksync-era/issues/3287)) ([98823f9](https://github.com/DeVikingMark/zksync-era/commit/98823f95c0b95feeb37eb9086cc88d4ac5220904))
* **prover:** Move prover_autoscaler config into crate ([#3222](https://github.com/DeVikingMark/zksync-era/issues/3222)) ([1b33b5e](https://github.com/DeVikingMark/zksync-era/commit/1b33b5e9ec04bea0010350798332a90413c482d3))
* **pruning:** Record L1 batch root hash in pruning logs ([#3266](https://github.com/DeVikingMark/zksync-era/issues/3266)) ([7b6e590](https://github.com/DeVikingMark/zksync-era/commit/7b6e59083cf0cafeaef5dd4b2dd39257ff91316d))
* pubdata type changes from sync-layer-stable ([#3425](https://github.com/DeVikingMark/zksync-era/issues/3425)) ([f09087b](https://github.com/DeVikingMark/zksync-era/commit/f09087bab397778976af42c321cbba93f9706b5a))
* Rework prover job handling ([#3561](https://github.com/DeVikingMark/zksync-era/issues/3561)) ([ddc4243](https://github.com/DeVikingMark/zksync-era/commit/ddc42435e5aa41122c165b14be64bf6b071c25a4))
* **state-keeper:** mempool io opens batch if there is protocol upgrade tx ([#3360](https://github.com/DeVikingMark/zksync-era/issues/3360)) ([f6422cd](https://github.com/DeVikingMark/zksync-era/commit/f6422cd59dab2c105bb7c125c172f2621fe39464))
* **state-keeper:** pre-insert unsealed L1 batches ([#2846](https://github.com/DeVikingMark/zksync-era/issues/2846)) ([e5b5a3b](https://github.com/DeVikingMark/zksync-era/commit/e5b5a3b7b62e8d4035fe89c2a287bf3606d17bc5))
* Support stable compiler for VM (and some other crates) ([#3248](https://github.com/DeVikingMark/zksync-era/issues/3248)) ([cbee99d](https://github.com/DeVikingMark/zksync-era/commit/cbee99d8661b38aa6b49784c3934b8070a743fb4))
* **tee_verifier:** speedup SQL query for new jobs ([#3133](https://github.com/DeVikingMark/zksync-era/issues/3133)) ([30ceee8](https://github.com/DeVikingMark/zksync-era/commit/30ceee8a48046e349ff0234ebb24d468a0e0876c))
* **tee:** add error handling for unstable_getTeeProofs API endpoint ([#3321](https://github.com/DeVikingMark/zksync-era/issues/3321)) ([26f630c](https://github.com/DeVikingMark/zksync-era/commit/26f630cb75958c711d67d13bc77ddbb1117156c3))
* **tee:** add support for recoverable signatures ([#3414](https://github.com/DeVikingMark/zksync-era/issues/3414)) ([7241a73](https://github.com/DeVikingMark/zksync-era/commit/7241a73b27d0e71cbe6644a741a685bf45d11d5f))
* **tee:** use hex serialization for RPC responses ([#2887](https://github.com/DeVikingMark/zksync-era/issues/2887)) ([abe0440](https://github.com/DeVikingMark/zksync-era/commit/abe0440811ae4daf4a0f307922a282e9664308e0))
* update FFLONK protocol version ([#3572](https://github.com/DeVikingMark/zksync-era/issues/3572)) ([a352852](https://github.com/DeVikingMark/zksync-era/commit/a3528522988093fbd2697b8fc35eb24f00166699))
* update l2 erc20 bridge address in updater as well ([#3500](https://github.com/DeVikingMark/zksync-era/issues/3500)) ([fe3c7b2](https://github.com/DeVikingMark/zksync-era/commit/fe3c7b2583bc4f9277e186334e5822ddf95bdcd0))
* **vm_executor:** Add new histogram metric for gas per tx in vm_executor ([#3215](https://github.com/DeVikingMark/zksync-era/issues/3215)) ([3606fc1](https://github.com/DeVikingMark/zksync-era/commit/3606fc1d8f103b4f7174301f9a985ace2b89038d))
* vm2 account validation ([#2863](https://github.com/DeVikingMark/zksync-era/issues/2863)) ([af149a0](https://github.com/DeVikingMark/zksync-era/commit/af149a01e6ce0c62d4b8a6acf9481e807ac24a8f))
* vm2 tracers can access storage ([#3114](https://github.com/DeVikingMark/zksync-era/issues/3114)) ([e466b52](https://github.com/DeVikingMark/zksync-era/commit/e466b52948e3c4ed1cb5af4fd999a52028e4d216))
* **vm:** add gateway changes to fast vm ([#3236](https://github.com/DeVikingMark/zksync-era/issues/3236)) ([f3a2517](https://github.com/DeVikingMark/zksync-era/commit/f3a2517a132b036ca70bc18aa8ac9f6da1cbc049))
* **vm:** Allow caching signature verification ([#3505](https://github.com/DeVikingMark/zksync-era/issues/3505)) ([7bb5ed3](https://github.com/DeVikingMark/zksync-era/commit/7bb5ed377719227f5c9861231e110dd9a5bb2ac0))
* **vm:** Do not panic on VM divergence ([#2705](https://github.com/DeVikingMark/zksync-era/issues/2705)) ([7aa5721](https://github.com/DeVikingMark/zksync-era/commit/7aa5721d22e253d05d369a60d5bcacbf52021c48))
* **vm:** EVM emulator support – base ([#2979](https://github.com/DeVikingMark/zksync-era/issues/2979)) ([deafa46](https://github.com/DeVikingMark/zksync-era/commit/deafa460715334a77edf9fe8aa76fa90029342c4))
* **vm:** Extract oneshot VM executor – environment types ([#2885](https://github.com/DeVikingMark/zksync-era/issues/2885)) ([a2d4126](https://github.com/DeVikingMark/zksync-era/commit/a2d4126f9e0c9dc46f49a861549d076fdbcf66d3))
* **vm:** Implement call tracing for fast VM ([#2905](https://github.com/DeVikingMark/zksync-era/issues/2905)) ([731b824](https://github.com/DeVikingMark/zksync-era/commit/731b8240abd4c0cfa42f2ce89c23f8ebf67e1bf2))
* **vm:** Return compressed bytecodes from `push_transaction()` ([#3126](https://github.com/DeVikingMark/zksync-era/issues/3126)) ([37f209f](https://github.com/DeVikingMark/zksync-era/commit/37f209fec8e7cb65c0e60003d46b9ea69c43caf1))
* **vm:** Split old and new VM implementations ([#2915](https://github.com/DeVikingMark/zksync-era/issues/2915)) ([93bc66f](https://github.com/DeVikingMark/zksync-era/commit/93bc66f21f9f67a440f06f1c4402e0d687698741))
* **vm:** Support EVM emulation in fast VM ([#3163](https://github.com/DeVikingMark/zksync-era/issues/3163)) ([9ad1f0d](https://github.com/DeVikingMark/zksync-era/commit/9ad1f0d77e5a5b411f7866ef6a1819373c07f91b))
* **vm:** Support missed storage invocation limit in fast VM ([#3548](https://github.com/DeVikingMark/zksync-era/issues/3548)) ([ef67694](https://github.com/DeVikingMark/zksync-era/commit/ef67694b3dfb45c6f003c01d9c171236c7e1edc1))
* **zk_toolbox:** add fees integration test to toolbox ([#2898](https://github.com/DeVikingMark/zksync-era/issues/2898)) ([e7ead76](https://github.com/DeVikingMark/zksync-era/commit/e7ead760ce0417dd36af3839ac557f7e9ab238a4))
* **zk_toolbox:** Add SQL format for zk supervisor ([#2950](https://github.com/DeVikingMark/zksync-era/issues/2950)) ([540e5d7](https://github.com/DeVikingMark/zksync-era/commit/540e5d7554f54e80d52f1bfae37e03ca8f787baf))
* **zk_toolbox:** added support for setting attester committee defined in a separate file ([#2992](https://github.com/DeVikingMark/zksync-era/issues/2992)) ([6105514](https://github.com/DeVikingMark/zksync-era/commit/610551427d5ab129f91e69b5efb318da917457d7))
* **zk_toolbox:** Redesign zk_toolbox commands ([#3003](https://github.com/DeVikingMark/zksync-era/issues/3003)) ([114834f](https://github.com/DeVikingMark/zksync-era/commit/114834f357421c62d596a1954fac8ce615cfde49))
* **zksync_cli:** Health checkpoint improvements ([#3193](https://github.com/DeVikingMark/zksync-era/issues/3193)) ([440fe8d](https://github.com/DeVikingMark/zksync-era/commit/440fe8d8afdf0fc2768692a1b40b0910873e2faf))
* **zktoolbox:** added checking the contract owner in set-attester-committee command ([#3061](https://github.com/DeVikingMark/zksync-era/issues/3061)) ([9b0a606](https://github.com/DeVikingMark/zksync-era/commit/9b0a6067923c5276f560f3abccedc4e6a5167dda))


### Bug Fixes

* add . to readme ([#3538](https://github.com/DeVikingMark/zksync-era/issues/3538)) ([512dd45](https://github.com/DeVikingMark/zksync-era/commit/512dd459307e57762dd4cc2c78ff4151634b6941))
* Add debug information to object store retries ([#3576](https://github.com/DeVikingMark/zksync-era/issues/3576)) ([036315c](https://github.com/DeVikingMark/zksync-era/commit/036315cd560acf8a7c6b9b288bb77f7fe336947a))
* **alerts:** Alert if there was no successful eth-watcher iterations for 5 minutes ([#3299](https://github.com/DeVikingMark/zksync-era/issues/3299)) ([0a09681](https://github.com/DeVikingMark/zksync-era/commit/0a096819a585f37510c6f01ac3b0aefd8edbe2f0))
* allow configuring NoDA client via ENV ([#3599](https://github.com/DeVikingMark/zksync-era/issues/3599)) ([a72ab63](https://github.com/DeVikingMark/zksync-era/commit/a72ab63e6c35412e8feb8def78099dd5b202950e))
* **api_server:** fix blob_gas length ([#2673](https://github.com/DeVikingMark/zksync-era/issues/2673)) ([44a8f79](https://github.com/DeVikingMark/zksync-era/commit/44a8f79739704e1216a7b34a0580ad7ba1cce3bd))
* **api:** Accept integer block count in `eth_feeHistory` ([#3077](https://github.com/DeVikingMark/zksync-era/issues/3077)) ([4d527d4](https://github.com/DeVikingMark/zksync-era/commit/4d527d4b44b6b083e2a813d48c79d8021ea6f843))
* **api:** Adapt `eth_getCode` to EVM emulator ([#3073](https://github.com/DeVikingMark/zksync-era/issues/3073)) ([15fe5a6](https://github.com/DeVikingMark/zksync-era/commit/15fe5a62f03cd103afd7fa5eb03e27db25686ba9))
* **api:** batch fee input scaling for `debug_traceCall` ([#3344](https://github.com/DeVikingMark/zksync-era/issues/3344)) ([7ace594](https://github.com/DeVikingMark/zksync-era/commit/7ace594fb3140212bd94ffd6bffcac99805cf4b1))
* **api:** Change `contractAddress` assignment for transaction receipts ([#3452](https://github.com/DeVikingMark/zksync-era/issues/3452)) ([4179711](https://github.com/DeVikingMark/zksync-era/commit/4179711c82c210e0a1236c37a2a97fb9311ef820))
* **api:** Fix batch fee input for `debug` namespace ([#2948](https://github.com/DeVikingMark/zksync-era/issues/2948)) ([79b6fcf](https://github.com/DeVikingMark/zksync-era/commit/79b6fcf8b5d10a0ccdceb846370dd6870b6a32b5))
* **api:** Fix pending transactions filter again ([#3630](https://github.com/DeVikingMark/zksync-era/issues/3630)) ([7afa20f](https://github.com/DeVikingMark/zksync-era/commit/7afa20f74ee54af0b49e2f42f7e673de26a07e4f))
* **api:** Improve estimation for gas_per_pubdata_limit ([#3475](https://github.com/DeVikingMark/zksync-era/issues/3475)) ([bda1b25](https://github.com/DeVikingMark/zksync-era/commit/bda1b25c67aed2d5cb7f7a1cc6eb0afc533c83b7))
* **api:** lock simultaneous tx insertsion with mutex ([#3616](https://github.com/DeVikingMark/zksync-era/issues/3616)) ([644b621](https://github.com/DeVikingMark/zksync-era/commit/644b62144da7bc1d12190c6e7cd2863aaaae985a))
* **api:** Propagate fallback errors in traces ([#3469](https://github.com/DeVikingMark/zksync-era/issues/3469)) ([84e3e31](https://github.com/DeVikingMark/zksync-era/commit/84e3e312688e3aaffe81828471d276e24432d496))
* **api:** Return correct flat call tracer ([#2917](https://github.com/DeVikingMark/zksync-era/issues/2917)) ([218646a](https://github.com/DeVikingMark/zksync-era/commit/218646aa1c56200f4ffee99b7f83366e2689354f))
* **api:** use scaled version of batch fee input in `get_batch_fee_input_impl` ([#3507](https://github.com/DeVikingMark/zksync-era/issues/3507)) ([86db9ff](https://github.com/DeVikingMark/zksync-era/commit/86db9ff6aed4017b0914ff6795295c45246282bf))
* Avail gas relay decoding issues ([#3547](https://github.com/DeVikingMark/zksync-era/issues/3547)) ([a171433](https://github.com/DeVikingMark/zksync-era/commit/a17143307ec3db898cf145665392d0a1530c17d0))
* bincode deserialization for VM run data ([#3044](https://github.com/DeVikingMark/zksync-era/issues/3044)) ([b0ec79f](https://github.com/DeVikingMark/zksync-era/commit/b0ec79fcb7fa120f095d987f53c67fdab92e2c79))
* bincode deserialize for WitnessInputData ([#3055](https://github.com/DeVikingMark/zksync-era/issues/3055)) ([91d0595](https://github.com/DeVikingMark/zksync-era/commit/91d0595631cc5f5bffc42a4b04d5015d2be659b1))
* block.timestamp is not accurate ([#3398](https://github.com/DeVikingMark/zksync-era/issues/3398)) ([adcb517](https://github.com/DeVikingMark/zksync-era/commit/adcb5172bf9aba308ae23c9031d32834be6997ea))
* **call_tracer:** Flat call tracer fixes for blocks ([#3095](https://github.com/DeVikingMark/zksync-era/issues/3095)) ([30ddb29](https://github.com/DeVikingMark/zksync-era/commit/30ddb292977340beab37a81f75c35480cbdd59d3))
* chainstack block limit exceeded ([#2974](https://github.com/DeVikingMark/zksync-era/issues/2974)) ([4ffbf42](https://github.com/DeVikingMark/zksync-era/commit/4ffbf426de166c11aaf5d7b5ed7d199644fba229))
* **ci:** commenting out getFilterChanges test until fix is ready ([#3582](https://github.com/DeVikingMark/zksync-era/issues/3582)) ([99c3905](https://github.com/DeVikingMark/zksync-era/commit/99c3905a9e92416e76d37b0858da7f6c7e123e0b))
* **consensus:** better logging of errors ([#3170](https://github.com/DeVikingMark/zksync-era/issues/3170)) ([a5028da](https://github.com/DeVikingMark/zksync-era/commit/a5028da65608898ad41c6a4fd5c6ec4c28a45703))
* **consensus:** made attestation controller non-critical ([#3180](https://github.com/DeVikingMark/zksync-era/issues/3180)) ([6ee9f1f](https://github.com/DeVikingMark/zksync-era/commit/6ee9f1f431f95514d58db87a4562e09df9d09f86))
* **consensus:** payload encoding protected by protocol_version ([#3168](https://github.com/DeVikingMark/zksync-era/issues/3168)) ([8089b78](https://github.com/DeVikingMark/zksync-era/commit/8089b78b3f2cdbe8d0a23e9b8412a8022d78ada2))
* **consensus:** preventing config update reverts ([#3148](https://github.com/DeVikingMark/zksync-era/issues/3148)) ([caee55f](https://github.com/DeVikingMark/zksync-era/commit/caee55fef4eed0ec58cceaeba277bbdedf5c6f51))
* **contract-verifier:** Fix verifier data migration ([#3608](https://github.com/DeVikingMark/zksync-era/issues/3608)) ([0bb0c88](https://github.com/DeVikingMark/zksync-era/commit/0bb0c886ad0d65fc97937680ebbc1fa6eb3d0c2c))
* **contract-verifier:** Fix version extraction in gh resolver ([#3378](https://github.com/DeVikingMark/zksync-era/issues/3378)) ([9a10dcf](https://github.com/DeVikingMark/zksync-era/commit/9a10dcf764e25c4e60b7ae5ddfa728c9cf576248))
* copy special case to fast VM call tracer ([#3509](https://github.com/DeVikingMark/zksync-era/issues/3509)) ([995e583](https://github.com/DeVikingMark/zksync-era/commit/995e583aa9b4ef6e0d8697fbb040e4b991a4248d))
* count SECP256 precompile to account validation gas limit as well ([#2859](https://github.com/DeVikingMark/zksync-era/issues/2859)) ([fee0c2a](https://github.com/DeVikingMark/zksync-era/commit/fee0c2ad08a5ab4a04252765b367eb9fbb1f3db7))
* **da-clients:** add padding to the data within EigenDA blob ([#3203](https://github.com/DeVikingMark/zksync-era/issues/3203)) ([8ae06b2](https://github.com/DeVikingMark/zksync-era/commit/8ae06b237647715937fb3656d881c0fd460f2a07))
* **da-clients:** enable tls-roots feature for tonic ([#3201](https://github.com/DeVikingMark/zksync-era/issues/3201)) ([42f177a](https://github.com/DeVikingMark/zksync-era/commit/42f177ac43b86cd24321ad9222121fc8a91c49e0))
* **en:** better defaults, i.e. the same as used by main node ([#3521](https://github.com/DeVikingMark/zksync-era/issues/3521)) ([2b5fe98](https://github.com/DeVikingMark/zksync-era/commit/2b5fe983acf78f73fb6e90a6a7d041e8aef1c595))
* **en:** Fix race condition in EN storage initialization ([#3515](https://github.com/DeVikingMark/zksync-era/issues/3515)) ([c916797](https://github.com/DeVikingMark/zksync-era/commit/c916797d49d636c9e642264786d4124ebd338ec3))
* **en:** make EN use main node's fee input ([#3489](https://github.com/DeVikingMark/zksync-era/issues/3489)) ([cbf2c31](https://github.com/DeVikingMark/zksync-era/commit/cbf2c31e353fd7a5167fcca7e2df87026050c21a))
* **en:** Return `SyncState` health check ([#3142](https://github.com/DeVikingMark/zksync-era/issues/3142)) ([abeee81](https://github.com/DeVikingMark/zksync-era/commit/abeee8190d3c3a5e577d71024bdfb30ff516ad03))
* eth aggregator restriction ([#3490](https://github.com/DeVikingMark/zksync-era/issues/3490)) ([6cc9b9e](https://github.com/DeVikingMark/zksync-era/commit/6cc9b9e405b03a7e30f3c92735b7452099c165d0))
* **eth_watch:** fix `get_events_inner` ([#2882](https://github.com/DeVikingMark/zksync-era/issues/2882)) ([c957dd8](https://github.com/DeVikingMark/zksync-era/commit/c957dd8011213e0e95fa5962e2310321b29a0d16))
* **eth-sender:** print better error message in case of missing blob prices ([#2927](https://github.com/DeVikingMark/zksync-era/issues/2927)) ([38fc824](https://github.com/DeVikingMark/zksync-era/commit/38fc824f75e8b0e84f10348d1502fc8a26d12015))
* **eth-watch:** add missing check that from_block is not larger than finalized_block ([#2969](https://github.com/DeVikingMark/zksync-era/issues/2969)) ([3f406c7](https://github.com/DeVikingMark/zksync-era/commit/3f406c7d0c0e76d798c2d838abde57ca692822c0))
* extend allowed storage slots for validation as per EIP-7562 ([#3166](https://github.com/DeVikingMark/zksync-era/issues/3166)) ([c76da16](https://github.com/DeVikingMark/zksync-era/commit/c76da16efc769243a02c6e859376182d95ab941d))
* **external-node:** delete empty unsealed batch on EN initialization ([#3125](https://github.com/DeVikingMark/zksync-era/issues/3125)) ([5d5214b](https://github.com/DeVikingMark/zksync-era/commit/5d5214ba983823b306495d34fdd1d46abacce07a))
* **external-node:** make fetcher rely on unsealed batches  ([#3088](https://github.com/DeVikingMark/zksync-era/issues/3088)) ([bb5d147](https://github.com/DeVikingMark/zksync-era/commit/bb5d1470d5e1e8e69d9b79c60284ea8adaee4038))
* Fflonk versioning ([#3610](https://github.com/DeVikingMark/zksync-era/issues/3610)) ([fc80840](https://github.com/DeVikingMark/zksync-era/commit/fc80840d355aab1e8c65ca60bd2f5cb12e0638ab))
* Fix counter metric type to be Counter. ([#3153](https://github.com/DeVikingMark/zksync-era/issues/3153)) ([08a3fe7](https://github.com/DeVikingMark/zksync-era/commit/08a3fe7ffd0410c51334193068649905337d5e84))
* fix execute encoding for transactions ([#3501](https://github.com/DeVikingMark/zksync-era/issues/3501)) ([4c381a8](https://github.com/DeVikingMark/zksync-era/commit/4c381a84346f8ab88d3f01dc2848c7fb5f2b788d))
* **gateway:** erc20 workaround for gateway upgrade ([#3511](https://github.com/DeVikingMark/zksync-era/issues/3511)) ([c140ba8](https://github.com/DeVikingMark/zksync-era/commit/c140ba8f57caabf9c9bdd4bd8c9743a9ccf668be))
* ignore unknown fields in rpc json response ([#2962](https://github.com/DeVikingMark/zksync-era/issues/2962)) ([692ea73](https://github.com/DeVikingMark/zksync-era/commit/692ea73f75a5fb9db2b4ac33ad24d20568638742))
* JSON proof serialization ([#3514](https://github.com/DeVikingMark/zksync-era/issues/3514)) ([516e521](https://github.com/DeVikingMark/zksync-era/commit/516e5210ed70b25a15a68a58c8065331aab542e0))
* **mempool:** minor mempool improvements ([#3113](https://github.com/DeVikingMark/zksync-era/issues/3113)) ([cd16083](https://github.com/DeVikingMark/zksync-era/commit/cd160830a0b7ebe5af4ecbd944da1cd51af3528a))
* **merkle-tree:** Fix tree truncation ([#3178](https://github.com/DeVikingMark/zksync-era/issues/3178)) ([9654097](https://github.com/DeVikingMark/zksync-era/commit/96540975d917761d8e464ebbdf52704955bcd898))
* **merkle-tree:** Repair stale keys for tree in background ([#3200](https://github.com/DeVikingMark/zksync-era/issues/3200)) ([363b4f0](https://github.com/DeVikingMark/zksync-era/commit/363b4f09937496fadeb38857f5c0c73146995ce5))
* **prover:** Run for zero queue to allow scaling down to 0 ([#3115](https://github.com/DeVikingMark/zksync-era/issues/3115)) ([bbe1919](https://github.com/DeVikingMark/zksync-era/commit/bbe191937fa5c5711a7164fd4f0c2ae65cda0833))
* restore instruction count functionality ([#3081](https://github.com/DeVikingMark/zksync-era/issues/3081)) ([6159f75](https://github.com/DeVikingMark/zksync-era/commit/6159f7531a0340a69c4926c4e0325811ed7cabb8))
* **state-keeper:** ensure unsealed batch is present during IO init ([#3071](https://github.com/DeVikingMark/zksync-era/issues/3071)) ([bdeb411](https://github.com/DeVikingMark/zksync-era/commit/bdeb411c593ac3d5e16158e64c4210bb00edcb0c))
* **state-keeper:** save call trace for upgrade txs ([#3132](https://github.com/DeVikingMark/zksync-era/issues/3132)) ([e1c363f](https://github.com/DeVikingMark/zksync-era/commit/e1c363f8f5e03c8d62bba1523f17b87d6a0e25ad))
* Support newer versions of foundry-zksync ([#3556](https://github.com/DeVikingMark/zksync-era/issues/3556)) ([d39fb6d](https://github.com/DeVikingMark/zksync-era/commit/d39fb6da7e7c19a7435a4f59d0e2eb9361db218f))
* **tee_prover:** add prometheus pull listener ([#3169](https://github.com/DeVikingMark/zksync-era/issues/3169)) ([1ffd22f](https://github.com/DeVikingMark/zksync-era/commit/1ffd22ffbe710469de0e7f27c6aae29453ec6d3e))
* **tee_prover:** add zstd compression ([#3144](https://github.com/DeVikingMark/zksync-era/issues/3144)) ([7241ae1](https://github.com/DeVikingMark/zksync-era/commit/7241ae139b2b6bf9a9966eaa2f22203583a3786f))
* **tee_verifier:** correctly initialize storage for re-execution ([#3017](https://github.com/DeVikingMark/zksync-era/issues/3017)) ([9d88373](https://github.com/DeVikingMark/zksync-era/commit/9d88373f1b745c489e98e5ef542644a70e815498))
* **tee:** correct previous fix for race condition in batch locking ([#3358](https://github.com/DeVikingMark/zksync-era/issues/3358)) ([b12da8d](https://github.com/DeVikingMark/zksync-era/commit/b12da8d1fddc7870bf17d5e08312d20773815269))
* **tee:** fix race condition in batch locking ([#3342](https://github.com/DeVikingMark/zksync-era/issues/3342)) ([a7dc0ed](https://github.com/DeVikingMark/zksync-era/commit/a7dc0ed5007f6b2f789f4c61cb3d137843151860))
* **tracer:** Add error to flat tracer ([#3306](https://github.com/DeVikingMark/zksync-era/issues/3306)) ([7c93c47](https://github.com/DeVikingMark/zksync-era/commit/7c93c47916845a90fc5a092e1465567aae611307))
* **tracer:** adds vm error to flatCallTracer error field if exists ([#3374](https://github.com/DeVikingMark/zksync-era/issues/3374)) ([5d77727](https://github.com/DeVikingMark/zksync-era/commit/5d77727cd3ba5f4d84643fee1873f03656310b4d))
* update logging in cbt l1 behaviour ([#3149](https://github.com/DeVikingMark/zksync-era/issues/3149)) ([d0f61b0](https://github.com/DeVikingMark/zksync-era/commit/d0f61b0552dcacc2e8e33fdbcae6f1e5fbb43820))
* use_dummy_inclusion_data condition ([#3244](https://github.com/DeVikingMark/zksync-era/issues/3244)) ([6e3c36e](https://github.com/DeVikingMark/zksync-era/commit/6e3c36e6426621bee82399db7814ca6756b613cb))
* **vm:** Check protocol version for fast VM ([#3080](https://github.com/DeVikingMark/zksync-era/issues/3080)) ([a089f3f](https://github.com/DeVikingMark/zksync-era/commit/a089f3feb916ccc9007d9c32ec909db694b7d9f4))
* **vm:** Do not require experimental VM config ([#3270](https://github.com/DeVikingMark/zksync-era/issues/3270)) ([54e4b00](https://github.com/DeVikingMark/zksync-era/commit/54e4b007b2d32d86b2701b01cd3bef3b3bc97087))
* **vm:** Fix VM divergences related to validation ([#3567](https://github.com/DeVikingMark/zksync-era/issues/3567)) ([170d194](https://github.com/DeVikingMark/zksync-era/commit/170d194fb0c629c61277e877a4493d52c3153c63))
* **vm:** Prepare new VM for use in API server and fix divergences ([#2994](https://github.com/DeVikingMark/zksync-era/issues/2994)) ([741b77e](https://github.com/DeVikingMark/zksync-era/commit/741b77e080f75c6a93d3ee779b1c9ce4297618f9))


### Performance Improvements

* **api:** More efficient gas estimation ([#2937](https://github.com/DeVikingMark/zksync-era/issues/2937)) ([3b69e37](https://github.com/DeVikingMark/zksync-era/commit/3b69e37e470dab859a55787f6cc971e7083de2fd))
* **db:** Remove `events.tx_initiator_address` writes and index ([#3559](https://github.com/DeVikingMark/zksync-era/issues/3559)) ([298abd2](https://github.com/DeVikingMark/zksync-era/commit/298abd2f988229a7fe5ee77de1015940d1d9ad41))
* **eth-sender:** optimize sql query ([#3437](https://github.com/DeVikingMark/zksync-era/issues/3437)) ([0731f60](https://github.com/DeVikingMark/zksync-era/commit/0731f607a72d18decd1ff74139f190c253d807ef))
* optimize get_unsealed_l1_batch_inner ([#3491](https://github.com/DeVikingMark/zksync-era/issues/3491)) ([9b121c9](https://github.com/DeVikingMark/zksync-era/commit/9b121c96bbb2e53be74aa81e0ca250ce9251f8db))


### Reverts

* **configs:** Add port parameter to ConsensusConfig ([#2986](https://github.com/DeVikingMark/zksync-era/issues/2986)) ([#3046](https://github.com/DeVikingMark/zksync-era/issues/3046)) ([abe35bf](https://github.com/DeVikingMark/zksync-era/commit/abe35bf7aea1120b77fdbd413d927e45da48d26c))
