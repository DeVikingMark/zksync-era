...
## [0.2.0](https://github.com/DeVikingMark/zksync-era/compare/zkstack_cli-v0.1.2...zkstack_cli-v0.2.0) (2025-02-27)
...
* Add option to run prover images from tag ([#3120](https://github.com/DeVikingMark/zksync-era/issues/3120)) ([3b532f5](https://github.com/DeVikingMark/zksync-era/commit/3b532f5e363e0cb093221e6d064ce1a7d7428b52))
...
* **gateway:** Add methods for token registration ([#3629](https://github.com/DeVikingMark/zksync-era/issues/3629)) ([abf8d00](https://github.com/DeVikingMark/zksync-era/commit/abf8d00266f6c482b1c48b371d391f7686f74381))
* **gateway:** Full indexing for token migration ([#3638](https://github.com/DeVikingMark/zksync-era/issues/3638)) ([b5fbee6](https://github.com/DeVikingMark/zksync-era/commit/b5fbee6abf6be2a7e6e8863508ce6266a12e0eb5))
...
* Update EVM emulator feature in zkstack and zk ([#3397](https://github.com/DeVikingMark/zksync-era/issues/3397)) ([e4848c5](https://github.com/DeVikingMark/zksync-era/commit/e4848c51fb12e13f1be490b14847d15528c87171))
* **zk_toolbox:** Add EVM emulator option to `zkstack` CLI ([#3139](https://github.com/DeVikingMark/zksync-era/issues/3139)) ([ffa18e1](https://github.com/DeVikingMark/zksync-era/commit/ffa18e1d84a4bb1ca9b897fbc0a55b9e3ef0964c))
...
* **zkstack_cli:** Add --dev flag to chain init and genesis ([#3152](https://github.com/DeVikingMark/zksync-era/issues/3152)) ([0aecae1](https://github.com/DeVikingMark/zksync-era/commit/0aecae1e02d31d34d1ccc0ddf54617174d134e55))
* **zkstack_cli:** Add status page ([#3036](https://github.com/DeVikingMark/zksync-era/issues/3036)) ([dd4b7cc](https://github.com/DeVikingMark/zksync-era/commit/dd4b7cc94e324dfa5a86df09f0cf15642ea2f5c2))
* **zkstack_cli:** Autocompletion support ([#3097](https://github.com/DeVikingMark/zksync-era/issues/3097)) ([b29be7d](https://github.com/DeVikingMark/zksync-era/commit/b29be7d9a8c664beac5d8384548db54de0ba882f))
...
* **zkstack_cli:** use docker-managed volumes ([#3140](https://github.com/DeVikingMark/zksync-era/issues/3140)) ([ee73a39](https://github.com/DeVikingMark/zksync-era/commit/ee73a3973b0c65b1d4acef12e4b64db8f813e77d))
* **zkstack_cli:** Use the same rust toolchain as main repo ([#3230](https://github.com/DeVikingMark/zksync-era/issues/3230)) ([e69d15b](https://github.com/DeVikingMark/zksync-era/commit/e69d15b6a80c36a19648a8dd90f567d1e5e108e9))
* **zkstack:** Introduce `build` and `wait` subcommands for components ([#3240](https://github.com/DeVikingMark/zksync-era/issues/3240)) ([e92b806](https://github.com/DeVikingMark/zksync-era/commit/e92b8068d71fec032e498793ff97e329c3d073e0))


### Bug Fixes

* add deploy timestamp asserter command ([#3252](https://github.com/DeVikingMark/zksync-era/issues/3252)) ([88a8940](https://github.com/DeVikingMark/zksync-era/commit/88a89405898653bf9e1a35a1374e000a8d67cf51))
...
* Fix wrong in ERC20 deployment file name ([#3395](https://github.com/DeVikingMark/zksync-era/issues/3395)) ([18e4307](https://github.com/DeVikingMark/zksync-era/commit/18e4307324f26902ef67ba587d324bf35aa09735))
* **gateway:** correct root hash / chain creation params ([#3613](https://github.com/DeVikingMark/zksync-era/issues/3613)) ([dd67d28](https://github.com/DeVikingMark/zksync-era/commit/dd67d289731df993c0a345106b3d52410e675d6c))
* return back new chain creation/genesis params ([#3640](https://github.com/DeVikingMark/zksync-era/issues/3640)) ([1781608](https://github.com/DeVikingMark/zksync-era/commit/17816081c8965e16ec9d59e2cf2054fbe51bdd45))
* revert "fix(gateway): correct root hash / chain creation params" ([#3631](https://github.com/DeVikingMark/zksync-era/issues/3631)) ([f813f9d](https://github.com/DeVikingMark/zksync-era/commit/f813f9da9ec3be181d0989bffede75ccdd101d3a))
* Run `zkstack dev lint -t autocompletion` to make CI happy. ([#3196](https://github.com/DeVikingMark/zksync-era/issues/3196)) ([1f8ad26](https://github.com/DeVikingMark/zksync-era/commit/1f8ad26c7c9757ffa13de1a2fd045fa9e16de5f6))
* **zk_toolbox:** Fix path to prover data handler port ([#3542](https://github.com/DeVikingMark/zksync-era/issues/3542)) ([e3759a2](https://github.com/DeVikingMark/zksync-era/commit/e3759a27158b2d6202fca19ada5344ddff36685b))
* zkstack readme update broken links and wording ([#3375](https://github.com/DeVikingMark/zksync-era/issues/3375)) ([ee117a8](https://github.com/DeVikingMark/zksync-era/commit/ee117a81e7708eece5639921e32b6683fbcb2280))
* **zkstack_cli:** make progress bar optional in non-terminal envs ([#3146](https://github.com/DeVikingMark/zksync-era/issues/3146)) ([5092031](https://github.com/DeVikingMark/zksync-era/commit/5092031050b30c39107df788317a15eaa921b136))
* **zkstack:** Fix loading genesis before cloning zksync-era repo ([#3271](https://github.com/DeVikingMark/zksync-era/issues/3271)) ([271033f](https://github.com/DeVikingMark/zksync-era/commit/271033fe58184252243b2ce7fe3a5a9be919b140))
* **zkstack:** Fix wrong missing private key message ([#3334](https://github.com/DeVikingMark/zksync-era/issues/3334)) ([aaca32b](https://github.com/DeVikingMark/zksync-era/commit/aaca32b6ab411d5cdc1234c20af8b5c1092195d7))
* **zkstack:** Move installation always to .local/bin ([#3108](https://github.com/DeVikingMark/zksync-era/issues/3108)) ([223e4dd](https://github.com/DeVikingMark/zksync-era/commit/223e4dd59414904f2b26afffc4b72bb78266b783))
* **zkstack:** shouldn't attempt to create db on migrate command ([#3468](https://github.com/DeVikingMark/zksync-era/issues/3468)) ([c156e79](https://github.com/DeVikingMark/zksync-era/commit/c156e791c1d8bbdea32873f43e976d35b228d38e))
